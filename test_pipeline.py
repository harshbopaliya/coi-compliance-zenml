"""
Test script for the COI Compliance Validation Pipeline
"""
...
def main():
    ...
    try:
        ...
        print(f"📝 Pipeline Run ID: {run_result.id}")
        print(f"🔗 Pipeline Run Name: {run_result.name}")
        print(f"📈 Pipeline Status: {run_result.status}")
